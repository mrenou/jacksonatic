...
import static com.github.mrenou.jacksonatic.mapping.ParameterCriteria.*;
...
public class DeserializationOnStaticFactoryest {
    ...
    public void not_deserialize_on_named_static_factory() throws IOException {
        configureMapping()
                .on(type(Pojo.class)
                        .onStaticFactory("other", ParameterCriteria.match(String.class, "field1"), match(Integer.class, "field2")))
                .registerIn(objectMapper);
