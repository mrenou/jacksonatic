 ...
 */
public interface MethodMapping extends HasAnnotations, PropertyMapper {
    ...
    @Override
    default MethodMapping add(AnnotationBuilder annotationBuilder) {
        return (MethodMapping) PropertyMapper.super.add(annotationBuilder);
    }

    @Override
    default MethodMapping map() {
        return (MethodMapping) PropertyMapper.super.map();
    }

    @Override
    default MethodMapping mapTo(String jsonProperty) {
        return (MethodMapping) PropertyMapper.super.mapTo(jsonProperty);
    }

    @Override
    default MethodMapping ignore() {
        return (MethodMapping) PropertyMapper.super.ignore();
    }
